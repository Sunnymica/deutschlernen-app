...
## **SCHRITT 2: Code auf GitHub einfügen**

1. **Geh zu GitHub:**
   👉 https://github.com/Sunnymica/deutschlernen-app/blob/main/src/App.tsx

2. **Klick auf den Stift** (Edit-Symbol oben rechts)

3. **Lösche ALLES** im Editor (Ctrl+A, dann Delete)

4. **Füge den neuen Code ein** (Ctrl+V)
